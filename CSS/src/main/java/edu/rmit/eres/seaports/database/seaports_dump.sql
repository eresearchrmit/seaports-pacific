...
INSERT INTO `data_source_display_types` VALUES (1,1),(1,5),(2,3),(3,3),(3,5),(4,3),(4,2),(5,2),(5,3),(6,1),(6,3),(7,1),(7,3),(8,3),(8,2),(9,3),(9,2);
...
INSERT INTO `data_source_element_category` VALUES (1,1),(2,1),(3,2),(4,2),(5,1),(5,4),(6,1),(7,2),(8,3),(9,3);
...
INSERT INTO `demographics_data` VALUES (1,'2011-01-01 00:00:00','Fiji Bureau of Statistics',139541,1911,1,1),(2,'2011-01-01 00:00:00','Fiji Bureau of Statistics',157266,1921,1,1),(3,'2011-01-01 00:00:00','Fiji Bureau of Statistics',198379,1936,1,1),(4,'2011-01-01 00:00:00','Fiji Bureau of Statistics',259638,1946,1,1),(5,'2011-01-01 00:00:00','Fiji Bureau of Statistics',345727,1956,1,1),(6,'2011-01-01 00:00:00','Fiji Bureau of Statistics',588068,1976,1,1),(7,'2011-01-01 00:00:00','Fiji Bureau of Statistics',715375,1986,1,1),(8,'2011-01-01 00:00:00','Fiji Bureau of Statistics',755077,1996,1,1),(9,'2011-01-01 00:00:00','Fiji Bureau of Statistics',837271,2007,1,1),(10,'2011-01-01 00:00:00','National Statistical Office of Papua New Guinea',2978057,1980,2,1),(11,'2011-01-01 00:00:00','National Statistical Office of Papua New Guinea',3582333,1990,2,1),(12,'2011-01-01 00:00:00','National Statistical Office of Papua New Guinea',5171548,2000,2,1);
...
INSERT INTO `demographics_variable` VALUES (1,'','Total Population','Total Population','people','');
...
--
-- Table structure for table `future_trend_data`
--

DROP TABLE IF EXISTS `future_trend_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `future_trend_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `creation_date` datetime DEFAULT NULL,
...
--
-- Dumping data for table `future_trend_variable`
--

LOCK TABLES `future_trend_variable` WRITE;
/*!40000 ALTER TABLE `future_trend_variable` DISABLE KEYS */;
INSERT INTO `future_trend_variable` VALUES (1,'Projected multi-model mean changes in annual mean surface air temperature for 2030, 2055 and 2090, relative to 1990, under the A2 (high), A1B (medium) and B1 (low) emissions scenarios. All models agree on warming in all locations.','Surface Air Temperature','T','&#8451;',''),(2,'Projected multi-modal mean changes in annual rainfall (mm/day) for 2030, 2055 and 2090, relative to 1990, under the A2 (high); A1B (medium) and B1 (low) emissions scenarios. Regions where at least 80% of the models agree on the direction of change are stippled.','Total Rainfall','RF','%','');
/*!40000 ALTER TABLE `future_trend_variable` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-05-14 11:56:47
