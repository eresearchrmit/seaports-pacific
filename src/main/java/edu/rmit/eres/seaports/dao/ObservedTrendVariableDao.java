...
/**
 * Data Access Object for the Observed Trend Variables
 * @author Guillaume Prevost
 */
@Repository
public class ObservedTrendVariableDao {
	
	@PersistenceContext
	private EntityManager entityManager;

	/**
	 * The name of the table in the database where the Observed Trends Variables are stored
	 */
	public final static String TABLE_NAME = "ObservedTrendVariable";
	 ...
	 * @return the trend variable from the database
	...
	public static final String ERR_NO_RESULT = "No observed trend variable found corresponding to the specified name";
}