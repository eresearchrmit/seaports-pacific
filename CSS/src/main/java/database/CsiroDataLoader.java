...
public class CsiroDataLoader {
	...
	public static void LoadCsiroData(Session session)
	{
		...
		// CMAR Data
		file = new File(cmarPictureFolderPath + "ECS/sealevelrise-ecs-2030.png");
		...
		// CMAR Data
		file = new File(cmarPictureFolderPath + "ECS/sealevelrise-ecs-2070.png");
		try { arrPictureContent = FileUtils.readFileToByteArray(file); }
		catch (IOException e) { arrPictureContent = null; e.printStackTrace(); }
		...
		// CMAR Data
		file = new File(cmarPictureFolderPath + "SSVE/sealevelrise-ssve-2030.png");
		try { arrPictureContent = FileUtils.readFileToByteArray(file); }
		catch (IOException e) { arrPictureContent = null; e.printStackTrace(); }
		...
		// CMAR Data
		file = new File(cmarPictureFolderPath + "SSVE/sealevelrise-ssve-2070.png");
		try { arrPictureContent = FileUtils.readFileToByteArray(file); }
		catch (IOException e) { arrPictureContent = null; e.printStackTrace(); }
		...
		// CMAR Data
		file = new File(cmarPictureFolderPath + "SSWFW/sealevelrise-sswfw-2030.png");
		try { arrPictureContent = FileUtils.readFileToByteArray(file); }
		catch (IOException e) { arrPictureContent = null; e.printStackTrace(); }
		...
		// CMAR Data
		file = new File(cmarPictureFolderPath + "SSWFW/sealevelrise-sswfw-2070.png");
		try { arrPictureContent = FileUtils.readFileToByteArray(file); }
		catch (IOException e) { arrPictureContent = null; e.printStackTrace(); }
