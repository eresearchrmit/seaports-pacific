ALTER TABLE `seaports_test`.`data_element_abs_data` DROP FOREIGN KEY `FKFD21512FBE7C83D4` , DROP FOREIGN KEY `FKFD21512F12C92CDE` ;

ALTER TABLE `seaports_test`.`data_element_abs_data` 

  ADD CONSTRAINT `FKFD21512FBE7C83D4`

  FOREIGN KEY (`abs_data_id` )

  REFERENCES `seaports_test`.`abs_data` (`id` )
...
ALTER TABLE `seaports_test`.`data_element_acorn_sat_data` DROP FOREIGN KEY `FK11EB5831EC94D333` , DROP FOREIGN KEY `FK11EB58316ACE14B7` ;

ALTER TABLE `seaports_test`.`data_element_acorn_sat_data` 

  ADD CONSTRAINT `FK11EB5831EC94D333`

  FOREIGN KEY (`acorn_sat_data_id` )

  REFERENCES `seaports_test`.`acorn_sat_data` (`id` )
...
ALTER TABLE `seaports_test`.`data_element_bitre_data` DROP FOREIGN KEY `FK92C34061ED5D362C` , DROP FOREIGN KEY `FK92C34061525894B0` ;

ALTER TABLE `seaports_test`.`data_element_bitre_data` 
  ...
  REFERENCES `seaports_test`.`bitre_data` (`id` )
...
ALTER TABLE `seaports_test`.`data_element_past_data` DROP FOREIGN KEY `FK12BA90DF7504AA8A` , DROP FOREIGN KEY `FK12BA90DF71A410AC` ;

ALTER TABLE `seaports_test`.`data_element_past_data` 

  ADD CONSTRAINT `FK12BA90DF7504AA8A`

  FOREIGN KEY (`past_data_id` )

  REFERENCES `seaports_test`.`past_data` (`id` )
