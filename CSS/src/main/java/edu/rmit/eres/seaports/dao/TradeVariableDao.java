...
/**
 * Data Access Object for the Trade Variables
 * @author Guillaume Prevost
 */
@Repository
public class TradeVariableDao {
	
	@PersistenceContext
	private EntityManager entityManager;

	/**
	 * The name of the table in the database where the Trade Variables are stored
	 */
	public final static String TABLE_NAME = "TradeVariable";
	 ...
	 * @return the Trade variable from the database
	...
	public static final String ERR_NO_RESULT = "No trade variable found corresponding to the specified name";
}