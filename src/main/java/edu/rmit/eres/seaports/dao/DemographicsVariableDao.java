...
/**
 * Data Access Object for the Demographics Variables
 * @author Guillaume Prevost
 */
@Repository
public class DemographicsVariableDao {
	
	@PersistenceContext
	private EntityManager entityManager;

	/**
	 * The name of the table in the database where the Demographics Variables are stored
	 */
	public final static String TABLE_NAME = "DemographicsVariable";
	 ...
	 * @return the Demographics variable from the database
	...
	public static final String ERR_NO_RESULT = "No demographics variable found corresponding to the specified name";
}