...
<div class="grid_12">
	<center>
		...
		<p class="info-paragraph">It features aids (applications) to investigate:
		<ul>
		<li>(i) port response to specific extreme weather events in the past,</li>
		<li>(ii) an assessment of port vulnerability to all extreme weather events with a priority rating in the form of a table, and</li>
		<li>(iii) a priority rating for future climate impacts in the form of a likelihood and consequence table.</li>
		</ul>
		</p>
		...
		<p class="info-paragraph">The "publish" function stores the final report on the Climate Smart Seaports site, to provide a growing repository of information and knowledge about climate change adaptation for peer-to-peer learning.</p>
