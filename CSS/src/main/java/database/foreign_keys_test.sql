...
ALTER TABLE `seaports_test`.`data_element_past_data` DROP FOREIGN KEY `FK12BA90DF7504AA8A` ;
...
ALTER TABLE `seaports_test`.`data_element_past_data` DROP FOREIGN KEY `FK12BA90DF71A410AC` ;
...
ALTER TABLE `seaports_test`.`data_element_acorn_sat_data` DROP FOREIGN KEY `FK11EB5831EC94D333` ;
...
ALTER TABLE `seaports_test`.`data_element_acorn_sat_data` DROP FOREIGN KEY `FK11EB58316ACE14B7` ;
