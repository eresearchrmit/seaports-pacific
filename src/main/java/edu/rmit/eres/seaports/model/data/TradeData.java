...
public class TradeData implements Serializable
{
	...
	private TradeVariable variable;
	
	/**
	 * Whether the trade data relates to import (true) or export (false)
	 */
	@Column
	 ...
	 */
	public TradeData(Date creationDate, Region region, Integer year, TradeVariable variable, Boolean imported, Double value, String sourceName) {
	 ...
	 */
	public TradeVariable getVariable() {
		return variable;
	}
	 ...
	 */
	public void setVariable(TradeVariable variable) {
		this.variable = variable;
	}
	
	/**
	 * Getter for whether the trade data relates to import (true) or export (false)
	 * @return: true if the data relates to imported goods, false otherwise
	 */
	...
	/**
	 * Getter for whether the trade data relates to import (true) or export (false)
	 * @param value: true if the data relates to imported goods, false otherwise
	 */
